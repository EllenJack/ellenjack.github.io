...
// 7.1.15 ToLength
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        var _icons = __webpack_require__(49);
        ...
        function renderEditor(_ref3, instance) {
            ...
            var _container$querySelec = container.querySelectorAll('.gitment-editor-tab'),
                _container$querySelec2 = (0, _slicedToArray3.default)(_container$querySelec, 2),
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        (function (global) {/* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "extras", function () {
                return extras;
            });
            ...
            /* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "Atom", function () {
                return Atom;
            });
            /* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "BaseAtom", function () {
                return BaseAtom;
            });
            /* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "useStrict", function () {
                return useStrict;
            });
            /* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "isStrictModeEnabled", function () {
            ...
            /* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "asReference", function () {
                return asReference;
            });
            /* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "asFlat", function () {
                return asFlat;
            });
            /* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "asStructure", function () {
                return asStructure;
            });
            /* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "asMap", function () {
                return asMap;
            });
            /* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "isModifierDescriptor", function () {
            ...
            /* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "IObservableFactories", function () {
            ...
            /* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "autorunAsync", function () {
                return autorunAsync;
            });
            /* harmony export (binding) */
            ...
            /* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "createTransformer", function () {
                return createTransformer;
            });
            /* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "whyRun", function () {
                return whyRun;
            });
            /* harmony export (binding) */
...
// Used by computed when its dependency changed, but we don't wan't to immediately recompute.
    ...
    * });
            ...
            __webpack_exports__["default"] = (everything);

            /* WEBPACK VAR INJECTION */
        }.call(__webpack_exports__, __webpack_require__(95)))
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        var _mobx = __webpack_require__(47);
        ...
        var Gitment = function () {
            (0, _createClass3.default)(Gitment, [{
                key: 'accessToken',
                get: function get() {
                ...
                get: function get() {
                    ...
                    var oauthParams = (0, _assign2.default)({
                        scope: scope,
            ...
            function Gitment() {
                ...
                try {
                    ...
                    if (this.accessToken && userInfo) {
                        (0, _assign2.default)(user, JSON.parse(userInfo), {
                            fromCache: true
                        });
                    }
                } catch (e) {
            ...
            (0, _createClass3.default)(Gitment, [{
                ...
                value: function update() {
                    ...
                    return _promise2.default.all([this.loadMeta(), this.loadUserInfo()]).then(function () {
                        return _promise2.default.all([_this4.loadComments().then(function () {
                ...
                value: function getIssue() {
                    if (this.state.meta.id) return _promise2.default.resolve(this.state.meta);
                ...
                value: function loadMeta() {
                    ...
                    return _utils.http.get('/repos/' + owner + '/' + repo + '/issues', {
                        ...
                        if (!issues.length) return _promise2.default.reject(_constants.NOT_INITIALIZED_ERROR);
                ...
                value: function loadUserInfo() {
                    ...
                    return _utils.http.get('/user').then(function (user) {
                        ...
                        localStorage.setItem(_constants.LS_USER_KEY, (0, _stringify2.default)(user));
                        return user;
                    });
                }
            }, {
                ...
                value: function loadCommentReactions() {
                    ...
                    return _promise2.default.all(comments.map(function (comment) {
                ...
                value: function unlike() {
                    ...
                    if (!this.accessToken) return _promise2.default.reject();
...
// 19.1.2.14 Object.keys(O)
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        var LIBRARY = __webpack_require__(35)
            , global = __webpack_require__(2)
            , ctx = __webpack_require__(10)
            , classof = __webpack_require__(16)
            , $export = __webpack_require__(7)
