...
![img](/images/thread-7/clip_image002.jpg)
...
![img](/images/thread-7/clip_image004.jpg)

![img](/images/thread-7/clip_image006.jpg)
...
![img](/images/thread-7/clip_image009.jpg)

![img](/images/thread-7/clip_image011.jpg)
...
![img](/images/thread-7/clip_image013.jpg)
...
![img](/images/thread-7/clip_image015.jpg)

定义一个VolatileLong类型的数组，然后让多个线程同时并发访问这个数组，这时可以想到，在多个线程同时处理数据时，数组中的多个VolatileLong对象可能存在同一个缓存行中。

![img](/images/thread-7/clip_image017.jpg)

运行后，可以得到运行时间

![img](/images/thread-7/clip_image019.jpg)

花费了39秒多。

我们改用进行了缓存行填充的变量

![img](/images/thread-7/clip_image021.jpg)

花费了8.1秒，如果任意注释上下填充行的任何一行，时间表现不稳定，从8秒到20秒都有，但是还是比不填充要快。具体原因目前未知。

再次改用注解标识的变量，同时加入参数-XX:-RestrictContended

![img](/images/thread-7/clip_image023.jpg)

![img](/images/thread-7/clip_image025.jpg)
...
![https://images0.cnblogs.com/i/475287/201403/091134177063947.jpg](/images/thread-7/clip_image026.jpg)

![img](/images/thread-7/clip_image028.jpg)

## Java内存模型带来的问题

### 可见性问题

![img](/images/thread-7/clip_image030.jpg)
...
![img](/images/thread-7/clip_image032.jpg)
...
![img](/images/thread-7/clip_image034.jpg)

例如：

![img](/images/thread-7/clip_image036.jpg)
...
![img](/images/thread-7/clip_image038.jpg) ![img](/images/thread-7/clip_image040.jpg)
...
![img](/images/thread-7/clip_image042.jpg)
...
![img](/images/thread-7/clip_image048.jpg)

站在我们Java程序员的角度：

![img](/images/thread-7/clip_image050.jpg)
...
![img](/images/thread-7/clip_image052.jpg)
...
![img](/images/thread-7/clip_image054.jpg)

可以看成

![img](/images/thread-7/clip_image056.jpg)
...
![img](/images/thread-7/clip_image068.jpg)
...
![img](/images/thread-7/clip_image070.jpg)
...
![img](/images/thread-7/clip_image072.jpg)
...
![https://images2018.cnblogs.com/blog/1271073/201711/1271073-20171125102857234-1570279063.png](/images/thread-7/clip_image074.jpg)
...
![img](/images/thread-7/clip_image077.jpg)
...
![https://images2018.cnblogs.com/blog/1271073/201711/1271073-20171125104323281-1174288720.png](/images/thread-7/clip_image079.jpg)
...
![img](/images/thread-7/clip_image081.jpg)
...
![img](/images/thread-7/clip_image083.jpg)
...
![img](/images/thread-7/clip_image085.jpg)

如果我们回顾第一章的VolatileCase，我们知道，为了让子线程可以及时看到*ready*变量的修改，我们需要将ready变量以volatile来修饰。

![img](/images/thread-7/clip_image087.jpg)

但是，当我们将程序做如下改造

![img](/images/thread-7/clip_image089.jpg)

我们可以看见子线程同样可以中止，为何？我们观察System.out.println的实现，

![img](/images/thread-7/clip_image091.jpg)
...
![img](/images/thread-7/clip_image093.jpg)

具体位置是对象头里面的MarkWord，MarkWord里默认数据是存储对象的HashCode等信息，

![img](/images/thread-7/clip_image095.jpg)

但是会随着对象的运行改变而发生变化，不同的锁状态对应着不同的记录存储方式

![https://img-blog.csdn.net/20161103154933259](/images/thread-7/clip_image097.jpg)
...
![img](/images/thread-7/clip_image099.jpg)
...
![img](/images/thread-7/clip_image101.jpg)

### 不同锁的比较 

![这里写图片描述](/images/thread-7/clip_image103.jpg)
