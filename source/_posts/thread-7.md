...
![img](/images/thread-7/clip_image001.png)
...
![img](/images/thread-7/clip_image003.png)

![img](/images/thread-7/clip_image005.png)
...
![https://pic3.zhimg.com/80/v2-b3ba7bc6352bbeaf4ca4dfff4373a180_hd.jpg](/images/thread-7/clip_image007.jpg)
...
![img](/images/thread-7/clip_image008.png)

![img](/images/thread-7/clip_image010.png)
...
![img](/images/thread-7/clip_image012.png)
...
![img](/images/thread-7/clip_image014.png)

定义一个VolatileLong类型的数组，然后让多个线程同时并发访问这个数组，这时可以想到，在多个线程同时处理数据时，数组中的多个VolatileLong对象可能存在同一个缓存行中。

![img](/images/thread-7/clip_image016.png)

运行后，可以得到运行时间

![img](/images/thread-7/clip_image018.png)

花费了39秒多。

我们改用进行了缓存行填充的变量

![img](/images/thread-7/clip_image020.png)

花费了8.1秒，如果任意注释上下填充行的任何一行，时间表现不稳定，从8秒到20秒都有，但是还是比不填充要快。具体原因目前未知。

再次改用注解标识的变量，同时加入参数-XX:-RestrictContended

![img](/images/thread-7/clip_image022.png)

![img](/images/thread-7/clip_image024.png)
...
![https://images0.cnblogs.com/i/475287/201403/091134177063947.jpg](/images/thread-7/clip_image025.png)

![img](/images/thread-7/clip_image027.png)

## Java内存模型带来的问题

### 可见性问题

![img](/images/thread-7/clip_image029.png)
...
![img](/images/thread-7/clip_image031.png)
...
![img](/images/thread-7/clip_image033.png)

例如：

![img](/images/thread-7/clip_image035.png)
...
![img](/images/thread-7/clip_image037.png) ![img](/images/thread-7/clip_image039.png)
...
![img](/images/thread-7/clip_image041.png)
...
![img](/images/thread-7/clip_image047.png)

站在我们Java程序员的角度：

![img](/images/thread-7/clip_image049.png)
...
![img](/images/thread-7/clip_image051.png)
...
![img](/images/thread-7/clip_image053.png)

可以看成

![img](/images/thread-7/clip_image055.png)
...
![img](/images/thread-7/clip_image067.png)
...
![img](/images/thread-7/clip_image069.png)
...
![img](/images/thread-7/clip_image071.png)
...
![https://images2018.cnblogs.com/blog/1271073/201711/1271073-20171125102857234-1570279063.png](/images/thread-7/clip_image073.png)
...
![https://images2018.cnblogs.com/blog/1271073/201711/1271073-20171125102857234-1570279063.png](/images/thread-7/clip_image075.jpg)
...
![img](/images/thread-7/clip_image076.png)
...
![https://images2018.cnblogs.com/blog/1271073/201711/1271073-20171125104323281-1174288720.png](/images/thread-7/clip_image078.png)
...
![img](/images/thread-7/clip_image080.png)
...
![img](/images/thread-7/clip_image082.png)
...
![img](/images/thread-7/clip_image084.png)

如果我们回顾第一章的VolatileCase，我们知道，为了让子线程可以及时看到*ready*变量的修改，我们需要将ready变量以volatile来修饰。

![img](/images/thread-7/clip_image086.png)

但是，当我们将程序做如下改造

![img](/images/thread-7/clip_image088.png)

我们可以看见子线程同样可以中止，为何？我们观察System.out.println的实现，

![img](/images/thread-7/clip_image090.png)
...
![img](/images/thread-7/clip_image092.png)

具体位置是对象头里面的MarkWord，MarkWord里默认数据是存储对象的HashCode等信息，

![img](/images/thread-7/clip_image094.png)

但是会随着对象的运行改变而发生变化，不同的锁状态对应着不同的记录存储方式

![https://img-blog.csdn.net/20161103154933259](/images/thread-7/clip_image096.png)
...
![img](/images/thread-7/clip_image098.png)
...
![img](/images/thread-7/clip_image100.png)

### 不同锁的比较 

![这里写图片描述](/images/thread-7/clip_image102.png)
